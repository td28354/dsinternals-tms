...
namespace DSInternals.Common.Data
{
    public static class AccountFactory
    {
        public static DSAccount CreateAccount(DirectoryObject dsObject, string netBIOSDomainName, DirectorySecretDecryptor pek, AccountPropertySets propertySets = AccountPropertySets.All)
        {
            ...
            if (accountType != SamAccountType.User)
                return null;
        ...
        public static DSAccount CreateAccount(DirectoryObject dsObject, string netBIOSDomainName, DirectorySecretDecryptor pek,
            SamAccountType samAccountType,
            AccountPropertySets propertySets = AccountPropertySets.All)
        {
            // Validate the input.
            Validator.AssertNotNull(dsObject, nameof(dsObject));
            ...
            if(accountType != SamAccountType.User) return null;
